...
import type { MysteryProject, NarrationChunk, Scene } from "./types";
...
async function synthesizeHookNarration(projectId: string, project: MysteryProject): Promise<void> {
 ...
 */
export async function synthesizeAllNarration(projectId: string, project: MysteryProject): Promise<void> {
